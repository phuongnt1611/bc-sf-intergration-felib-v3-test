...
public class User_01_Register_DRY {
	...
	public void TC_02_Register_Invalid_Email() {
		...
		driver.findElement(By.cssSelector("input#Email")).sendKeys("adasds");
	...
	public void TC_06_Register_Invalid_Confirm_PassWord() {
		...
		driver.findElement(By.cssSelector("input#LastName")).sendKeys("FC");
		driver.findElement(By.cssSelector("input#Email")).sendKeys(emailAddress);
		driver.findElement(By.cssSelector("input#Password")).sendKeys("1234568");
		driver.findElement(By.cssSelector("input#ConfirmPassword")).sendKeys("1234545");
